    ...
    <div className="sm:p-5 p-3 flex flex-row justify-center items-center">
      <div className="w-full flex flex-col justify-center items-center p-0">
        <Link
          href={props.projLink}
          target="_blank"
          className="uppercase sm:text-2xl text-lg sm:font-semibold font-semibold text-black sm:p-3 mb-5 sm:mb-8 p-2 border-4 border-gray-300 bg-[rgb(254,20,147)] shadow-[0.25rem_0.25rem_0px_0px_rgba(0,0,0,1)] rounded-xl"
        >
          {props.projName}
        </Link>
